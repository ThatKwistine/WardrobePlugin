...
Settings → Size Options opens to one list with a rule between groups, and the button reads what
is in effect — with Muse on you are wearing Muse, and "YAB mini" is what you go back to.
